defmodule LemonadechickenWeb.Components.Overlay do
  @moduledoc """
  The `LemonadechickenWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `LemonadechickenWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
