defmodule LemonadechickenWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `LemonadechickenWeb.Components.Carousel`
  project.
