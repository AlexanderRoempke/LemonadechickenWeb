defmodule LemonadechickenWeb.Components.Pagination do
  @moduledoc """
  The `LemonadechickenWeb.Components.Pagination` module provides a comprehensive and highly customizable
