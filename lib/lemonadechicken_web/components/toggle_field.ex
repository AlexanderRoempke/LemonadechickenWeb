defmodule LemonadechickenWeb.Components.ToggleField do
  @moduledoc """
  LemonadechickenWeb.Components.ToggleField component renders a toggle field with customizable options.
