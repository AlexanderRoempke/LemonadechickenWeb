defmodule LemonadechickenWeb.Components.Image do
  @moduledoc """
  The `LemonadechickenWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
