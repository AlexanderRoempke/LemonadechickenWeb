defmodule LemonadechickenWeb.Components.Stepper do
  @moduledoc """
  The `LemonadechickenWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `LemonadechickenWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
