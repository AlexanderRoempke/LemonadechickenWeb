defmodule LemonadechickenWeb.Components.Spinner do
  @moduledoc """
  The `LemonadechickenWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `LemonadechickenWeb.Components.Spinner` module enables developers to provide
