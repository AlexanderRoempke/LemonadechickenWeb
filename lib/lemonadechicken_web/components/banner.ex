defmodule LemonadechickenWeb.Components.Banner do
  @moduledoc """
  LemonadechickenWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
