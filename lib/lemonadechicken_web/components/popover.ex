defmodule LemonadechickenWeb.Components.Popover do
  @moduledoc """
  The `LemonadechickenWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
