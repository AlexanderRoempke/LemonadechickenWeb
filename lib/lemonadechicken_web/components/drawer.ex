defmodule LemonadechickenWeb.Components.Drawer do
  @moduledoc """
  The `LemonadechickenWeb.Components.Drawer` module provides a flexible and customizable drawer component
