defmodule LemonadechickenWeb.Components.Gallery do
  @moduledoc """
  The `LemonadechickenWeb.Components.Gallery` module provides a customizable gallery component for displaying
