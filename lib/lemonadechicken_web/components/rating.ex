defmodule LemonadechickenWeb.Components.Rating do
  @moduledoc """
  The `LemonadechickenWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
