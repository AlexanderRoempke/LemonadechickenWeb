defmodule LemonadechickenWeb.Components.Footer do
  @moduledoc """
  The `LemonadechickenWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
