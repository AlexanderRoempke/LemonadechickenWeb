defmodule LemonadechickenWeb.Components.Menu do
  @moduledoc """
  The `LemonadechickenWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `LemonadechickenWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import LemonadechickenWeb.Components.Accordion, only: [accordion: 1]
  import LemonadechickenWeb.Components.Button, only: [button_link: 1]
