defmodule LemonadechickenWeb.Components.TableContent do
  @moduledoc """
  `LemonadechickenWeb.Components.TableContent` is a component module designed to create flexible and dynamic
