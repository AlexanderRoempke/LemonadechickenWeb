defmodule LemonadechickenWeb.Components.Chat do
  @moduledoc """
  `LemonadechickenWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
