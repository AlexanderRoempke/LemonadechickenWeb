defmodule LemonadechickenWeb.Components.Modal do
  @moduledoc """
  The `LemonadechickenWeb.Components.Modal` module provides a versatile and customizable modal component for
