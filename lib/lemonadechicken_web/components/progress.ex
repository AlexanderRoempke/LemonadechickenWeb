defmodule LemonadechickenWeb.Components.Progress do
  @moduledoc """
  The `LemonadechickenWeb.Components.Progress` module provides a customizable progress bar component for
