defmodule LemonadechickenWeb.Components.MegaMenu do
  @moduledoc """
  The `LemonadechickenWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
