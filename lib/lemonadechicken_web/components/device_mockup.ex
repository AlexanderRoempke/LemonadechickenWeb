defmodule LemonadechickenWeb.Components.DeviceMockup do
  @moduledoc """
  The `LemonadechickenWeb.Components.DeviceMockup` module provides a customizable component for displaying
