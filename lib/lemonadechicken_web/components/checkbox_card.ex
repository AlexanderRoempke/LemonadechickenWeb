defmodule LemonadechickenWeb.Components.CheckboxCard do
  @moduledoc """
  The `LemonadechickenWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
