defmodule LemonadechickenWeb.Components.Tabs do
  @moduledoc """
  `LemonadechickenWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import LemonadechickenWeb.Components.Badge, only: [badge: 1]
