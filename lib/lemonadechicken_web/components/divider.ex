defmodule LemonadechickenWeb.Components.Divider do
  @moduledoc """
  The `LemonadechickenWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `LemonadechickenWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
