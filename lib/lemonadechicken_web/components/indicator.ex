defmodule LemonadechickenWeb.Components.Indicator do
  @moduledoc """
  The `LemonadechickenWeb.Components.Indicator` module provides a versatile component for visually highlighting
