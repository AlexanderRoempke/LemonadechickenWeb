defmodule LemonadechickenWeb.Components.FileField do
  @moduledoc """
  The `LemonadechickenWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LemonadechickenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LemonadechickenWeb.Gettext, "errors", msg, opts)
    end
  end
end
