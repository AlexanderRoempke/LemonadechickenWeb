defmodule LemonadechickenWeb.Components.Button do
  @moduledoc """
  Provides a comprehensive set of button components for the `LemonadechickenWeb.Components.Button` project.
