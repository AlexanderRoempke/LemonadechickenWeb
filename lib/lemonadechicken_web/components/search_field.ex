defmodule LemonadechickenWeb.Components.SearchField do
  @moduledoc """
  The `LemonadechickenWeb.Components.SearchField` module provides a highly customizable search input
