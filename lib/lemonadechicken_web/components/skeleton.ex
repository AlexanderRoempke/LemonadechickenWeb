defmodule LemonadechickenWeb.Components.Skeleton do
  @moduledoc """
  The `LemonadechickenWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
