defmodule LemonadechickenWeb.Components.UrlField do
  @moduledoc """
  LemonadechickenWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
