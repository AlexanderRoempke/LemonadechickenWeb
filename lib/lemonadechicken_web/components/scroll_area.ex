defmodule LemonadechickenWeb.Components.ScrollArea do
  @moduledoc """
  The `LemonadechickenWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
