defmodule LemonadechickenWeb.Components.SpeedDial do
  @moduledoc """
  The `LemonadechickenWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
