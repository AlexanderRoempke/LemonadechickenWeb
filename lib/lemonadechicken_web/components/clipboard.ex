defmodule LemonadechickenWeb.Components.Clipboard do
  @moduledoc """
  The `LemonadechickenWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
