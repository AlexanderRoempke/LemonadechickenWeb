defmodule LemonadechickenWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `LemonadechickenWeb.Components.Breadcrumb` component for displaying
