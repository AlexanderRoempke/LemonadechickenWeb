defmodule LemonadechickenWeb.Components.Jumbotron do
  @moduledoc """
  The `LemonadechickenWeb.Components.Jumbotron` module provides a versatile component for creating large,
